...
public class ATL_EMFTVM_Launcher {
	...
	public static void executeATLTransformationSeveralTimes(String executionsCanPath, List<String> IN_MM_PATHS, List<String> OUT_MM_PATHS, //The paths after the executionsCanPath
		...
		launchSeveralTimes(executionsCanPath,IN_MM_PATHS, OUT_MM_PATHS, IN_MM_NAMES_TRAFO,OUT_MM_NAMES_TRAFO,IN_MODEL_NAMES_TRAFO,OUT_MODEL_NAMES_TRAFO,IN_MODEL_PATHS,OUT_MODEL_PATHS,transformationDir,transformationModule,numModels,numMutants);
	}
	...
	//			}
				...
				inModel1.setResource(rs.getResource(URI.createURI(executionsCanPath + "/" + MODELS_FOLDER + "/" + INDIVIDUAL_MODEL_FOLDER + j + "/AutomaticModel_" + IN_MM_PATHS.get(0).substring(0, IN_MM_PATHS.get(0).length()-6) + j + ".xmi", true), true));
				env.registerInputModel(IN_MODEL_NAMES_TRAFO.get(0), inModel1);
				Model inModel2 = EmftvmFactory.eINSTANCE.createModel();
				inModel2.setResource(rs.getResource(URI.createURI(executionsCanPath + "/" + MODELS_FOLDER + "/" + INDIVIDUAL_MODEL_FOLDER + j + "/" + IN_MM_PATHS.get(1).substring(0, IN_MM_PATHS.get(1).length()-6) + "_out" + j + "_Mutant" + k +".xmi"), true));
	...
	//			}
				Model outModel = EmftvmFactory.eINSTANCE.createModel();
				outModel.setResource(rs.createResource(URI.createURI(executionsCanPath + "/" + MODELS_FOLDER + "/" + INDIVIDUAL_MODEL_FOLDER + j + "/" + "JointModel" + j + "_Mutant" + k + ".xmi")));
