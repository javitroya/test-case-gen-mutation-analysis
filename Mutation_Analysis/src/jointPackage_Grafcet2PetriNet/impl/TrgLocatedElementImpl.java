 ...
 * </p>
 * <ul>
 *   <li>{@link jointPackage_Grafcet2PetriNet.impl.TrgLocatedElementImpl#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TrgLocatedElementImpl extends MinimalEObjectImpl.Container implements TrgLocatedElement {
	...
	protected EClass eStaticClass() {
		return JointPackage_Grafcet2PetriNetPackage.Literals.TRG_LOCATED_ELEMENT;
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JointPackage_Grafcet2PetriNetPackage.TRG_LOCATED_ELEMENT__LOCATION, oldLocation, location));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case JointPackage_Grafcet2PetriNetPackage.TRG_LOCATED_ELEMENT__LOCATION:
				return getLocation();
		}
